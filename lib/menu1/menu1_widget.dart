...
/// Resumo do progresso pessoal:
///
///     Indicadores rápidos: assiduidade, últimas aulas frequentadas, desafios
/// em curso.
///
/// Secções:
///
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Vamos continuar a sua jornada fitness',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                    ...
                    children: [
                      Expanded(
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(AgendarWidget.routeName);
                          },
                          child: Container(
                            width: 100.0,
                            decoration: BoxDecoration(
