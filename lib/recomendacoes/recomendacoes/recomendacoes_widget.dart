...
/// Ecrã de RecomendaçõesObjetivo: Sugerir treinos e dicas.🏋️ Treinos
/// Personalizados🥗 Dicas de Nutrição as dicas de nutrição por topico
class RecomendacoesWidget extends StatefulWidget {
  const RecomendacoesWidget({super.key});

  static String routeName = 'recomendacoes';
  static String routePath = '/recomendacoes';
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Treinos e dicas personalizadas para você',
                          style:
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Quando comer antes e após treino',
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Descubra a quantidade ideal de proteína para seus objetivos de treino e recuperação muscular.',
                                        maxLines: 3,
                                        style: FlutterFlowTheme.of(context)
                                            .bodySmall
                                            .override(
